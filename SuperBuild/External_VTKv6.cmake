...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(Slicer_REQUIRED_QT_MAYORVERSION)
  string(SUBSTRING ${Slicer_REQUIRED_QT_VERSION} 0 1 Slicer_REQUIRED_QT_MAYORVERSION)
  message(STATUS "qt mayor version: ${Slicer_REQUIRED_QT_MAYORVERSION} ")
 

  list(APPEND EXTERNAL_PROJECT_OPTIONAL_ARGS
	-DCMAKE_PREFIX_PATH:PATH=${CMAKE_PREFIX_PATH} 
    -DVTK_QT_VERSION:STRING=${Slicer_REQUIRED_QT_MAYORVERSION} 
    -DVTK_USE_GUISUPPORT:BOOL=ON
    -DVTK_USE_QVTK_QTOPENGL:BOOL=ON
    -DVTK_USE_QT:BOOL=ON
    -DModule_vtkTestingRendering:BOOL=ON
	-DModule_vtkIOPLY:BOOL=ON
	-DModule_vtkImagingMorphological:BOOL=ON
	...
	-DModule_vtkGUISupportMFC:BOOL=OFF
